package com.alibaba.health.utils;
...
public class QiNiuUtils {
    ...
    private static final String ACCESSKEY = "AatfF8SCkGyOfq45xhlZQvS0eG3ho9ST-FwnjApc";
    private static final String SECRETKEY = "lmesyoOYRdfEpuaEGMdfcvL3cutmtb7sKcOeSdkY";
    private static final String BUCKET = "yykkk";
    public static final String DOMAIN= "http://qmlzw2nx1.hn-bkt.clouddn.com/";

    public static void main(String[] args) {
        uploadFile("C:\\Users\\yykk\\Desktop\\xiaochou.jpg","dt2.jpg");
